...
/*
  TFT gpio对应
  PB为数据口	  
  CS PE.0    RS PC.4    WR PC.2     RD PC.0	  RES PE.4复位
  BL PE.2(背光亮度控制  配合硬件调节)
...
void Lcd_GPIO_Init(void)
{
 ...
 RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOC|RCC_APB2Periph_GPIOB|RCC_APB2Periph_GPIOE, ENABLE);	//使能PC端口时钟
