...
static void LCD__BLK(void)
{
	...
	GPIO_InitStructure.GPIO_Pin = LCD_BLK|LCD_DC;	 
 	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP; 		 //推挽输出
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;//速度50MHz
 	GPIO_Init(GPIOC, &GPIO_InitStructure);	  //初始化GPIOA
 	GPIO_SetBits(GPIOC,LCD_BLK|LCD_DC);
}
void LCD_GPIO_Init(void)
{
	...
	GPIO_InitStructure.GPIO_Pin =  LCD_SDI | LCD_SCL | LCD_CS ;
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP; 		 //推挽输出
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;//速度50MHz
	GPIO_Init(GPIOB, &GPIO_InitStructure);
	GPIO_SetBits(GPIOB,  LCD_SDI | LCD_SCL | LCD_CS );
